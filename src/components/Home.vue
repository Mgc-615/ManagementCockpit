  ...
  <div>
      ...
      <div class="clearfloat">
        ...
        <div class="cardLeft">
          ...
          <div class="arrNum">
            <ul class="clearfloat">
              <li>
                <p>Contract under Execution</p>
                <span>￥ {{overview.execution}}</span>
              </li>
              <li>
                <p>Total Budget</p>
              ...
              <li>
                <p>Subcontract</p>
                <span>￥ {{overview.subcontract}}</span>
              </li>
              <li>
                <p>Cash - in</p>
                <span>￥ {{overview.cashin}}</span>
              </li>
              <li>
                <p>Cash - out</p>
                <span>￥ {{overview.cashout}}</span>
              </li>
            </ul>
          </div>
          <div class="abc" ref="mypic" style="width:100%; height: 340px;"></div>
        </div>
        <!-- 上半部分右侧tab切换 -->
        <div class="cardRight">
          <el-row>
            <el-col :span="24">
              <div class="title">Enterprise Manpower Status</div>
              <el-tabs>
                <!-- 切换第一项 -->
                <el-tab-pane label="Enterprise">
                  <div class="rightitle">
                    <span>Manpower Composition</span>
                    <span>
                      <img src="../assets/img/reload time 拷贝@2x.png" alt />
                      Last Updated : 5/21/2019
                    </span>
                  </div>
                  <div class="getWidth" ref="onepic" style="width:100%; height: 182px;"></div>
                  <p class="onetwo">Manpower Forecast</p>
                  <div class="butPadd" ref="onebutpic" style="width:100%; height: 182px;"></div>
                </el-tab-pane>
                <!-- 切换第二项 -->
                <el-tab-pane label="Engineering">
                  <div class="rightitle">
                    <span>Engineering Staff Status</span>
                  </div>
                  <div ref="twopic" style="width:100%; height: 182px;"></div>
                  <div class="rightitle">
                    <p>Engineering Staff Status</p>
                  </div>
                  <!-- <div ref="twobutpic" style="width:100%; height: 182px;"></div> -->
                  <div id="c1"></div>
                </el-tab-pane>
              </el-tabs>
            </el-col>
    ...
    <div class="butfirst">
      ...
      <div class="clearfloat">
            ...
            <el-col :span="24">
              ...
              <el-tabs type="border-card">
                <el-tab-pane label="Portfolios">
                  <el-table :data="tableData" style="width: 100%!important" height="339" @row-dblclick="toPortfolio">
                    <el-table-column
                      fixed
                      type="index"
                      prop="index"
                      ...
                      width="60%"
                    ></el-table-column>
                    <el-table-column fixed prop="Name" label="Portfolio Name" width="200"></el-table-column>
                    ...
                    <el-table-column prop="CashIn" label="Cash-in"></el-table-column>
                  </el-table>
                </el-tab-pane>
                <el-tab-pane label="Programs" style="height:339px">
                  <el-table :data="tableData" style="width: 100%" @row-dblclick="toPortfolio">
                    <el-table-column
                      type="index"
                      prop="index"
                      label="S.N."
                      ...
                      width="60%"
                    ></el-table-column>
                    <el-table-column prop="Name" label="Program Name" width="200"></el-table-column>
                    <el-table-column prop="Region" label="Region"></el-table-column>
                    <el-table-column prop="value" label="Value"></el-table-column>
                    <el-table-column prop="Budget" label="Budget"></el-table-column>
                    <el-table-column prop="Cost" label="Cost"></el-table-column>
        ...
        <!-- 下半部分右侧tab切换 -->
        <div class="twocardright">
          <el-row>
            <el-col :span="24">
              <div class="link" @click="toHs()">
                Enter HSSE System
                <i class="el-icon-arrow-right"></i>
              </div>
              <el-tabs type="border-card">
                <!-- 切换第一项 -->
                <el-tab-pane label="HSSE">
                  <div class="mapwith" ref="botpica" style="width:100%; height: 360px;"></div>
                </el-tab-pane>
                <!-- 切换第二项 -->
                <el-tab-pane label="QA / QC">
                  <div ref="twobotpicb" style="width:100%; height: 360px;"></div>
                </el-tab-pane>
              </el-tabs>
            </el-col>
          </el-row>
...
export default {
  mounted() {
    ...
    this.format_number(this.overview)
  ...
  methods: {
    //加载页面数据
    getdata(){
      this.corporateOverview()
    },
    //获取overview数据
    corporateOverview(){
      this.$API.corporateOverview().then(res=>{
        console.log('res',res)
      })
    },
    //格式化数字
    format_number(obj){
      for(var p in obj){
        obj[p]= this.tools.format_number(obj[p])
      }
    },
    toHs(){
      window.open('http://114.247.112.149/')
    },
    toPortfolio(row,column,event){
      console.log("row",row,"column",column,"event",event)
      this.$router.push({path:'/share/'+'11'})
      this.$emit("listenactNav",'share')
    },
    // 世界地图相关数据
    paintPic() {
      let myChart = echarts.init(this.$refs.mypic)
      //地图数据
      var data=[
        {name:'Amsterdam',value:100,id:11}
      ]
      // 世界地图上点的位置
      var geoCoordMap = {
    ...
    // 上半部分page1右侧第一个饼状图相关
    paintLeft() {
      let objdata={'cashin':333}
      console.log('data',objdata)
      let twoChart = echarts.init(this.$refs.onepic)
      let option = {
        tooltip: {
          trigger: 'item',
        ...
        series: [
          {
            ...
            label: {
              ...
              position: 'center',
              rich: {
                color1: { color: '#8C919A', fontSize: 12 },
      ...
      let getWidth = document.querySelector('.topfirst').clientWidth
      let echartWidth = getWidth * 0.34
      twoChart.resize({
        width: echartWidth
      })
    ...
    // 上半部分page1右侧第二个柱状图相关
    paintbutLeft() {
      let twoChart = echarts.init(this.$refs.onebutpic)
      let option = {
        tooltip: {
          trigger: 'axis',
          axisPointer: {
    ...
    // 上半部分page2右侧第一个饼状图相关
    paintRight() {
      let twoChart = echarts.init(this.$refs.twopic)
      let option = {
        tooltip: {
          trigger: 'item',
          formatter: '{a} <br/>{b}: {c} ({d}%)',
    ...
    paintbutRight() {
     ...
     const chart = new G2.Chart({
      ...
      chart.guide().html({
        position: ['20%', '38%'],
        html:
          '<div style="color:#8C919A;font-size: 12px;text-align: center;width: 10em;">Outsourced<br><span style="color:#36484F;font-size:25px">17%</div>',
        alignX: 'middle',
        alignY: 'middle'
      })
      ...
      view1
        .intervalStack()
        .position('value')
        .color('type', ['l(100) 0:#2D78C9 1:#3894EA', '#37CBCB'])
        .opacity(1)
        ...
        series: [
          {
            ...
            label: {
              ...
              position: 'center',
              rich: {
                color1: { color: '#8C919A', fontSize: 10 },
                color2: { fontSize: 29, padding: [5, 0], color: '#36484F' }
              }
            },
            emphasis: {
              label: {
            ...
            //     return [
            //       param.data.name,
            //       '<br />Quantity: ' + param.value,
            //       '<br />Ratio：' + param.percent + '%'
            //     ].join('');
            //   }
            // },
            data: [
    ...
    // 下半部分右侧QA/QC线形图
    paintbutQa() {
      let twoChart = echarts.init(this.$refs.twobotpicb)
      let option = {
        tooltip: {
          trigger: 'axis',
          // formatter: '{b}: {c} ({d}%)',
        ...
        series: [
          {
            ...
            data: [10, 30, 20, 26, 50, 60, 40, 20, 26, 50, 60, 40],
            areaStyle: {
              normal: {
                //设置线下面部分颜色渐变
                color: new echarts.graphic.LinearGradient(0, 0, 0, 1, [
                  { offset: 0, color: '#3FA3FE' },
                  { offset: 1, color: '#fff' }
                ])
              }
            }
